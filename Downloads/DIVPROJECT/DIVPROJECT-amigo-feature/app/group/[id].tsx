    ...
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      ...
      <View style={styles.headerCard}>
        ...
        <View style={styles.totalCard}>
          ...
          <Text style={styles.totalAmount}>{formatARS(totalARS)}</Text>
      ...
      <View style={styles.membersCard}>
        <Text style={[styles.sectionTag, styles.membersSectionTag]}>PARTICIPANTES</Text>
      ...
      <AddMemberSheet
        ...
        onJoinByCode={(code) => joinGroupByCode(code)}
      />
