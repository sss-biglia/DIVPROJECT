...
import { accentColor, accentGradient } from '../constants/metallicTheme';
...
const TabButton = ({ route, isFocused, navigation, descriptor }: TabButtonProps) => {
  void descriptor;
  ...
  return (
    ...
    >
      ...
      <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
        <Ionicons
          color={isFocused ? accentColor : '#4a4a4a'}
          name={iconName}
          size={22}
        />
      </Animated.View>
      <Text
        style={[styles.tabLabel, { color: isFocused ? accentColor : '#4a4a4a' }]}
      >
        {label}
      </Text>
    </Pressable>
