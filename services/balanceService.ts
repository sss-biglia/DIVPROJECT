...
export const getMemberBalances = (group: Group | null | undefined): MemberBalance[] => {
...
export const simplifySettlements = (group: Group | null | undefined): SettlementSuggestion[] => {
  if (!group || !group.members) return [];
