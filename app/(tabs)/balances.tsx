  ...
  return (
    <>
      ...
      <Screen scrollable contentContainerStyle={styles.content}>
        ...
        <AppCard style={styles.totalCard} animated={false}>
          ...
          globalTotals.map((item) => {
            ...
            return (
              <View key={item.name} style={styles.balanceRow}>
                ...
                <Text style={[styles.balanceValue, !positive && styles.balanceValueNegative]}>
                  {formatARS(Math.abs(item.total))}
                </Text>
              </View>
            );
          })
        ...
        {groups.length === 0 ? (
          ...
          return (
            <AppCard key={group.id} style={styles.groupCard} animated={false}>
